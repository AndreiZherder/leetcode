...
First operation on enemy 1: points increases by 1, and currentEnergy decreases by 2. So, points = 1,
and currentEnergy = 0.
Second operation on enemy 0: currentEnergy increases by 3, and enemy 0 is marked. So, points = 1,
currentEnergy = 3, and marked enemies = [0].
...
def main():
    enemyEnergies = [3, 2, 2]
    currentEnergy = 2
    print(Solution().maximumPoints(enemyEnergies, currentEnergy))
