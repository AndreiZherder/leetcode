...
such that word can be obtained by concatenating s an arbitrary number of times. For example, if word == “ababab”,
...
We can obtain a 4-periodic string by picking i = 4 and j = 0.
