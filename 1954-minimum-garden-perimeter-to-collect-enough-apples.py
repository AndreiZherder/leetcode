...
Given an integer neededApples, return the minimum perimeter of a plot such that at least neededApples apples
are inside or on the perimeter of that plot.
    ...
    def minimumPerimeter(self, neededApples: int) -> int:
        def bsl(left: int, right: int) -> int:
            ...
            def check(mid: int) -> bool:
                return 2 * mid * (mid + 1) * (2 * mid + 1) >= neededApples
