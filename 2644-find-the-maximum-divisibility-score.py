...
Since divisors[0], divisors[1], and divisors[2] all have the maximum divisibility score,
we return the minimum of them (i.e., divisors[2]).
Example 3:
    ...
    def maxDivScore(self, nums: List[int], divisors: List[int]) -> int:
        ...
        for i, divisor in enumerate(divisors):
            ...
            if cur > best:
                ...
                if divisor < divisors[besti]:
                    besti = i
        return divisors[besti]
