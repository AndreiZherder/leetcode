...
Then we mark 3 of the smallest unmarked elements with the smallest indices,
...
Then we mark 2 of the smallest unmarked elements with the smallest indices if they exist,
