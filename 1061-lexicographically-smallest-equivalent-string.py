...
"acd" and "aab" are equivalent strings of baseStr = "eed", and "aab" is the lexicographically smallest
...
class Solution:
    def smallestEquivalentString(self, s1: str, s2: str, baseStr: str) -> str:
        ...
        rank = {c: 1 for c in 'abcdefghijklmnopqrstuvwxyz'}
        ...
        return ''.join(d[find(c)][0] for c in baseStr)
