...
greater than the sum of elements not included. However, the subsequence [10,9] has
...
is the minimal satisfying the conditions. Note the subsequence has to be returned in non-increasing order.
