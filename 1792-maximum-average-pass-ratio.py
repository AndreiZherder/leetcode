...
number of students of the class. The average pass ratio is the sum of pass ratios of all the classes divided
...
Output: 0.78333
Explanation: You can assign the two extra students to the first class. The average pass ratio will be equal to
...
class Solution:
    def maxAverageRatio(self, classes: List[List[int]], extraStudents: int) -> float:
        ...
        while extraStudents:
            ...
            heappush(h, (-((p + 1) / (t + 1) - p / t), i))
            extraStudents -= 1
        return sum(c[0] / c[1] for c in classes) / n
