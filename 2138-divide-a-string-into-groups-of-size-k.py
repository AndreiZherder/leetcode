...
The first group consists of the first k characters of the string, the second group consists of the next
k characters of the string, and so on. Each character can be a part of exactly one group.
...
class Solution:
    def divideString(self, s: str, k: int, fill: str) -> List[str]:
        ...
        m = (k - n % k) % k
        s += m * fill
        return [s[i:i + k] for i in range(0, n + m, k)]
