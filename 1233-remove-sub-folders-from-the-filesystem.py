...
must start with folder[j], followed by a "/". For example, "/a/b" is a sub-folder of "/a", but "/b"
...
class Solution:
    def removeSubfolders(self, folder: List[str]) -> List[str]:
        arr = [f.split('/') for f in folder]
        trie = Trie(arr)
        return trie.get_words()
