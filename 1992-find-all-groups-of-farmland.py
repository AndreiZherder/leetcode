...
These rectangular areas are called groups. No two groups are adjacent, meaning farmland
    ...
    def findFarmland(self, land: List[List[int]]) -> List[List[int]]:
        ...
        while s:
            ...
            if land[i][j] == 1:
                ...
                bottom = i
                right = j
                while (top - 1, j) in s and land[top - 1][j] == 1:
                    top -= 1
                while (i, left - 1) in s and land[i][left - 1] == 1:
                    left -= 1
                while (bottom + 1, j) in s and land[bottom + 1][j] == 1:
                    bottom += 1
                while (i, right + 1) in s and land[i][right + 1] == 1:
                    right += 1
